  ...
  return (
    <section className="orbit-report-hub">
      ...
      <section className="orbit-report-list-shell" aria-labelledby="orbit-report-project-list">
        ...
        {state === "ready" && items.length === 0 ? <OrbitEmptyState action={<OrbitButton onClick={() => navigateTo("/project?intent=rehearsal")} variant="secondary">리허설 시작하기</OrbitButton>} description="리허설을 완료하면 프로젝트별 리포트가 이곳에 쌓입니다." title="아직 완료된 리허설이 없습니다." /> : null}
