...
describe("TableCellHitTargets", () => {
  ...
  it("renders transparent hit rects from the same proportional bounds as the renderer", () => {
  ...
  it("clears both the active cell and editing element when the table becomes disabled", () => {
