...
import { CreateAiDeckReferenceExtractionArtifacts2026071504000 } from "./2026071504000-CreateAiDeckReferenceExtractionArtifacts";
...
describe("CreateAiDeckReferenceExtractionArtifacts migration", () => {
  it("creates one tenant-safe OCR artifact per pipeline file", async () => {
    ...
    await new CreateAiDeckReferenceExtractionArtifacts2026071504000().up(
      queryRunner,
    );
  ...
  it("restores the 338-0 empty reference constraint on revert", async () => {
    ...
    await new CreateAiDeckReferenceExtractionArtifacts2026071504000().down(
      queryRunner,
    );
