...
describe("database migration registry", () => {
  it("registers the latest migrations in order", () => {
    ...
    expect(
      migrationNames.indexOf("AddUserDisplayNames2026072104000"),
    ).toBeLessThan(
    ...
    expect(
      ...
      migrationNames.indexOf("AddDesignAgentMotionPlan2026072301000"),
    );
    expect(latest).toBe("AddDesignAgentMotionPlan2026072301000");
  });
});
