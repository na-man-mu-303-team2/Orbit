...
export const kdhHomeProjectSeeds = [
  [
    "브랜드 리뉴얼 제안",
    "/assets/home-project-covers/01-brand-renewal.webp",
    "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "2026 제품 로드맵",
    "/assets/home-project-covers/02-product-roadmap.webp",
    "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "지속가능성 보고서",
    "/assets/home-project-covers/03-sustainability-report.webp",
    "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "디지털 전환 전략",
    "/assets/home-project-covers/04-digital-transformation.webp",
    "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "고객 경험 인사이트",
    "/assets/home-project-covers/05-customer-insights.webp",
    "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "분기별 비즈니스 리뷰",
    "/assets/home-project-covers/06-quarterly-review.webp",
    "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "팀 온보딩 가이드",
    "/assets/home-project-covers/07-team-onboarding.webp",
    "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "시장 진출 계획",
    "/assets/home-project-covers/08-market-entry.webp",
    "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "크리에이티브 캠페인",
    "/assets/home-project-covers/09-creative-campaign.webp",
    "https://images.unsplash.com/photo-1497366412874-3415097a27e7?auto=format&fit=crop&w=1920&q=85",
  ],
  [
    "2026 연간 성과 공유",
    "/assets/home-project-covers/10-annual-results.webp",
...
export function getKdhHomeProjectSeeds(): KdhHomeProjectSeed[] {
  return kdhHomeProjectSeeds.map(([title, imageUrl, legacyImageUrl], index) => {
