        ...
        `
          WITH json_asset AS (
            INSERT INTO project_assets (
              file_id, project_id, created_by_user_id, storage_key, original_name, mime_type, size,
              url, purpose, status, created_at, uploaded_at, deleted_at
            )
            VALUES (
              $3, $1, $11, $5, 'transcript.json', 'application/json; charset=utf-8',
          ...
          text_asset AS (
            ...
            VALUES (
              $4, $1, $11, $6, 'transcript.txt', 'text/plain; charset=utf-8',
