...
> [!IMPORTANT]
> 이 문서는 2026-07-12의 생성 품질 승인 근거를 보존하는 이력 문서다. 구현 목표는 후속 확정 계획인 #341 → #339 → #338을 따른다. 이 문서의 legacy/template 생성 유지 결정은 #339가, web research·Visual QA 실패 정책은 #338이 대체한다. 품질 기준과 승인 fixture는 후속 작업의 회귀 기준으로 계속 사용한다.
