...
- `text.props`는 `text`, `runs`, `fontFamily`, `fontSize`, `fontWeight`, `color`, `align`, `verticalAlign`, `lineHeight`, `bullet`을 사용한다. `runs`는 PPTX OOXML rich text import에서 run-level font/color/weight를 보존하기 위한 optional field다.
